    ...
    return async (dispatch) => {
        try {
            ...
            let obj = {}
                ...
                let all_val = (parseInt(web3.utils.fromWei((reward_info.statics))) + parseInt(web3.utils.fromWei((reward_info.directs)))  + parseInt(web3.utils.fromWei((reward_info.diamond ))) + parseInt(web3.utils.fromWei((reward_info.doubleDiamond))) + parseInt(web3.utils.fromWei((reward_info.directPool))) + parseInt(web3.utils.fromWei((roi))))
